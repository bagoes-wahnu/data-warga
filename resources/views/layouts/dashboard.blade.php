...
<head>
	...
	<meta name="description" content="DataWarga - Aplikasi Kelola Data Warga">
	<meta name="author" content="DataWarga>
  <meta name="keyword" content="Aplikasi Kelola Data Warga">
...
<body class="app sidebar-fixed aside-menu-fixed sidebar-lg-show">
    ...
    <footer class="app-footer">
        <div>
            <span>&copy; 2020 Pakis Sawahan.</span>
        </div>
        <div class="ml-auto">
